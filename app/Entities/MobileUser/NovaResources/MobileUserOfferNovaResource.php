...
use App\Entities\MobileUser\ActionsNova\MobileUserDetachOfferAction;
...
class MobileUserOfferNovaResource extends BaseNovaResource
{

    public static $model = MobileUser::class;
    public static $category = 'Клиенты';
    public static $defaultSort = 'phone';
    public static $hasTransaction = true;
    public static $displayInNavigation = false;
    public static $with = ['offers'];
    ...
    public function actions(Request $request)
    {
        return [
            ...
            (new MobileUserDetachOfferAction)->withoutActionEvents()->withMeta([
                'offer_id' => $request->query('viaResourceId')
            ]),
        ];
    }
    ...
    protected function getFields(): array
    {
        return [
            ...
            Text::make('Телефон', 'phone', function () {
                return '<a href="/admin-panel/resources/mobile-user-auth-nova-resources/' . $this->id . '" class="no-underline dim text-primary font-bold">' . $this->phone . '</a>';
